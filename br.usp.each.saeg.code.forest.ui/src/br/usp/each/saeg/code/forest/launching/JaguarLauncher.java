 ...
 */
public abstract class JaguarLauncher implements ICoverageLauncher, IExecutableExtension {
	...
	private ILaunchConfigurationDelegate getLaunchDelegate(String launchtype) throws CoreException {
		...
		if (type == null) {
			throw new CoreException(CodeForestStatus.UNKOWN_LAUNCH_TYPE_ERROR.getStatus(launchtype));
		}
	...
	private void runJaguar() {
		try {
			System.out.println(properties);
			JaguarRunner.main(new String[] { properties.getHeuristic(), properties.getProjectDir(), properties.getCompiledClassesDir(),
